...
module.exports = {
    ...
    addProduct: async (req, res) => {
        ...
        console.log("Files multer line 27: ",req.files);
        ...
        let imagePath = [];
        let path = "/assets/images/uploaded";
        ...
        // let path = "/assets/images/uploaded";
        // const {images} = req.files; // Karena lebih dari satu, pake files
        // // const data = JSON.parse(req.body.data);
        // let imagePath = images ? `${path}/${images[0].filename}` : null;
